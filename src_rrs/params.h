...
uns64       RH_THRESHOLD_ACT    = 512; //number of activations beyond which rowhammer bitflips might be possible.
//-----------------------
...
uns64       MEM_T_ROW_MOV   = (2* cycles_for_read) + (2* cycles_for_write);  // for moving one swap operation 
//----------------------
//
